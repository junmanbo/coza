        ...
        for symbol in symbols:
            try:
                ...
                # 조건 만족시 Long Position
                    ...
                    order1 = binance.create_limit_sell_order(symbol, quantity, current_price * bull_profit) # 지정가 매수 주문
                ...
                # 조건 만족시 Short Position
                    ...
                    order1 = binance.create_limit_buy_order(symbol, quantity, current_price * bear_profit) # 지정가 매도 주문
