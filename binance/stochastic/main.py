...
while True:
    try:
        for symbol in symbols:
            ...
            # 조건을 만족하면 지정가 매수
            elif temp[symbol]['hold'] == False and total_hold < 3 and stochastic['slow_k'][-1] < 40 and stochastic['slow_signal'][-1] >= 0:
            ...
            # 조건을 만족하면 지정가 공매도
            elif temp[symbol]['hold'] == False and total_hold < 3 and stochastic['slow_k'][-1] > 75 and stochastic['slow_signal'][-1] <= 0:
