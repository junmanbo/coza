    ...
    try:
        ...
        if now.minute == 0:
            ...
            for symbol in symbols:
                ...
                # 코인 미보유 시 거래 (롱)
                if info[symbol]['position'] == 'wait' and info[symbol]['slow_osc'] > 0 and info[symbol]['slow_osc_slope'] > 0:
                ...
                # 코인 미보유 시 거래 (숏)
                elif info[symbol]['position'] == 'wait' and info[symbol]['slow_osc'] < 0 and info[symbol]['slow_osc_slope'] < 0:
